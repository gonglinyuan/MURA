...
def run_train():
    ...
    path_log = '../../trained_models/' + timestamp + '-resnet50-adam-augslight-revised/tb'
    model_name = 'RESNET50'
    model_pretrained = True
    batch_size = 16
    epoch_num = 100
    path_model = '../../trained_models/' + timestamp + '-resnet50-adam-augslight-revised/m-' + timestamp + '.pth.tar'
