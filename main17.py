...
def run_train():
    ...
    path_log = '../../trained_models/' + timestamp + '-seresnext101_32x4d-adam-augslight-revised/tb'
    model_name = 'SERESNEXT101_32x4d'
    model_pretrained = True
    batch_size = 16
    epoch_num = 100
    path_model = '../../trained_models/' + timestamp + '-seresnext101_32x4d-adam-augslight-revised/m-' + timestamp + '.pth.tar'
