...
def run_train():
    ...
    path_log = '../../trained_models/' + timestamp + '-senet154-adam-augslight-revised/tb'
    model_name = 'SENET154'
    model_pretrained = True
    batch_size = 16
    epoch_num = 100
    path_model = '../../trained_models/' + timestamp + '-senet154-adam-augslight-revised/m-' + timestamp + '.pth.tar'
