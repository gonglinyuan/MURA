...
def main():
    runTest("../../trained_models/20180504-014522/m-20180504-014522.pth.tar")
    # run_train()
...
def run_train():
    ...
    train.train(
        ...
        checkpoint=None,
        device=device,
        transform_train=data_augmentation.default_transform_revised(img_size=354, crop_size=331, target_mean=0.5,
                                                                    target_std=0.5),
