...
def run_train():
    ...
    path_log = '../../trained_models/' + timestamp + '-dualpathnet107_5k-adam-augslight/tb'
    model_name = 'DUALPATHNET107_5k'
    model_pretrained = True
    batch_size = 16
    epoch_num = 100
    path_model = '../../trained_models/' + timestamp + '-dualpathnet107_5k-adam-augslight/m-' + timestamp + '.pth.tar'
